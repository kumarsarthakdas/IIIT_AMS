...
import { ProfileProps, AssetProps } from 'interfaces/common';
...
const Profile = ({ type, name, avatar, email, assets }: ProfileProps) => (
  <Box>
    ...
    >
      ...
      >
        <img
          src="https://images.unsplash.com/photo-1652449823136-b279fbe5dfd3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=725&q=80"
          width={340}
          height={320}
          alt="abstract"
          ...
          <Box flex={1} display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap="20px">
            ...
            <Box flex={1} display="flex" flexDirection="column" justifyContent="space-between" gap="30px">
              <Stack direction="column">
                ...
                <Typography fontSize={16} color="#808191">IIIT Bhubaneswar</Typography>
              </Stack>
    ...
    {assets.length > 0 && (
      <Box
        ...
        bgcolor="#FCFCFC"
      >
        <Typography fontSize={18} fontWeight={600} color="#11142D">{type} Assets</Typography>
        ...
        >
          {assets?.map((asset: AssetProps) => (
            <AssetCard key={asset._id} id={asset._id}
              title={asset.title}
